...
def add_buffer(open_file: 'file_object'):
    count= 0
    amount= 10
    total= []
    buffer= []
...
if __name__ == '__main__':
    start= time.time()
    #json_files, names = file_paths()   # Get file names
    #index_files(json_files, names)     # Index
